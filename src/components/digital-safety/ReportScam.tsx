    ...
    return (
      <Card variant="success" className="bg-success/10">
        <div className="p-6 text-center space-y-4">
          ...
          <Card
            variant="primary"
            className="bg-primary/10 text-sm text-foreground text-left"
          >
            <p>
              <strong>What happens next?</strong>
              <br />
              Our community will verify your report. Once verified, it will help
          ...
          <div className="flex gap-2 pt-2">
            ...
            <Button className="flex-1">View Database</Button>
          </div>
        </div>
      </Card>
    );
    ...
    <div className="space-y-4">
      ...
      <Card variant="destructive">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-bold text-lg text-foreground">Report a Scam</h2>
      ...
      <Card variant="elevated">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-3 gap-2">
            {channelOptions.map((option) => (
              ...
              >
                <div
                  className={`mx-auto mb-1 ${channel === option.value ? "text-primary" : "text-muted-foreground"}`}
                >
                  {option.icon}
                </div>
                <span
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            This will be shared publicly to warn others (your identity stays
            anonymous)
          </p>
        </div>
